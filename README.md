...
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/TailFile.jpg)
...
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/SplitText.jpg)
...
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/ExtractText.jpg)
...
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/Storm-Flow.jpg)
...
```
# cd /opt/
# git clone https://github.com/jobinthompu/NiFi-Storm-Log-Integration.git
```

2) Feel free the inspect pom.xml to verify the dependencies.

```
# cd /opt/NiFi-Storm-Log-Integration
# vi pom.xml
```
...
```
# ls -l /opt/NiFi-Storm-Log-Integration/target/NiFiStormTopology-Uber.jar
```
...
```
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/StormView.jpg)

```
Storm UI: http://your-vm-ip:8744/index.html
```
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/StormUI.jpg)
...
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/sqlline.jpg)
...
```
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/Zeppelin.jpg)
...
```
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/RouteOnAttribute.jpg)
...
```
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/AttributesToJSON.jpg)
...
```
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/Phoenix-Storm.jpg)
...
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/ConvertJSONToSQL.jpg)
...
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/ReplaceText.jpg)
...
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/PutSQL.jpg)
...
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/Final_Flow.jpg)
...
```
![alt tag](https://github.com/jobinthompu/NiFi-Storm-Log-Integration/blob/master/resources/images/Zeppelin_Final.jpg)
